...
python3.9 audit_general.py -d data/FedAus/federal_2016_NT.stv -outcome data/FedAus/federal_2016_NT.otc -quota 34010 -voters 105539 -e1 0.002 -e2 0 -r 0.10 -log "data/FedAus/federal_2016_NT.0.10.0.002GEN.log" 

python3.9 audit_general.py -d data/FedAus/federal_2019_NT.stv -outcome data/FedAus/federal_2019_NT.otc -quota 35010 -voters 108994 -e1 0.002 -e2 0 -r 0.10 -log "data/FedAus/federal_2019_NT.0.10.0.002GEN.log" 


python3.9 audit_general.py -d data/FedAus22/2022NT.json -outcome data/FedAus22/2022NT.otc_D2 -quota 35010 -voters 108994 -e1 0.002 -e2 0 -r 0.10 -log "data/FedAus/federal_2022_NT.0.10.0.002GEN.log" 
